...
async function getWEU(cookieModCas) {
    let config = {
        ...
        headers: {
            ...
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 (5236115968)cpdaily/9.0.20  wisedu/9.0.20',
...
async function doPassRequest(info, cookie) {
    ...
    let config = {
        ...
        headers: {
            ...
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 (4462986240)cpdaily/9.0.20  wisedu/9.0.20',
            'Referer': 'http://ehall.fzu.edu.cn/qljapp/sys/lwWiseduElectronicPass/*default/index.do',
            'Cookie': cookie,
        },
        data: qs.stringify({
